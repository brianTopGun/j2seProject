...
public class TestJDBC {
    public static void main(String[] args) throws Exception {
        ...
        *   jdbc:mysql://127.0.0.1:3306/mysqldb
        * */
        String url="jdbc:mysql://127.0.0.1:3306/mysqldb?useSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
        String user="root";
